...
Unlearning Machine, bilişsel davranışçı terapi (BDT) tekniklerini interaktif dijital deneyimle birleştiren kişisel gelişim aracıdır. Kullanıcıların olumsuz düşünce kalıplarını fark etmelerine ve dönüştürmelerine yardımcı olur.

🔗 **Canlı Demo:** [https://unlearning-machine.streamlit.app](https://unlearning-machine.streamlit.app)
...
- 🔐 **Güvenli**: Tüm veriler yerel olarak işlenir
...
🐛 Hata Bildirimi
Sorun mu yaşadınız? GitHub Issues üzerinden bildirin.

🤝 Geliştirici
Murat Mustafa Ciritçi
https://github.com/muratmustafaciritci
https://linkedin.com/in/muratmustafaciritci
https://www.muratciritci.com.tr
📧 E-posta: muratmustafaciritci@gmail.com
